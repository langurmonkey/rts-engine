...
public class RTSGame implements ApplicationListener {
	...
	public void initShaders() {
		shader = new ShaderProgram(Gdx.files.internal("data/shaders/default.vert"),
				Gdx.files.internal("data/shaders/vignette-sepia.frag"));
	...
	public void create() {
		...
		Unit gooner = new Gunner(80f, 40f, map);
		entities.add(tank1);
		entities.add(tank2);
		entities.add(tank3);
		entities.add(tank4);
	...
	public void resize(int width, int height) {
		...
		shader.begin();
		shader.setUniformf("screen_res", (float) Gdx.graphics.getWidth(), (float) Gdx.graphics.getHeight());
		shader.end();
	}
