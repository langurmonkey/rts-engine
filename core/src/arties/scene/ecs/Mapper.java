...
public class Mapper {
    ...
    public static final ComponentMapper<RenderableVehicleComponent> rvehicle = ComponentMapper.getFor(RenderableVehicleComponent.class);
    ...
    public static final ComponentMapper<MovingComponent> velocity = ComponentMapper.getFor(MovingComponent.class);
}
